...
Единый геттер-сеттер используется реже, чем две отдельные функции, но в некоторых JavaScript-библиотеках, например [jQuery](https://jquery.com) и [D3](https://d3js.org), подобный подход принят на уровне концепта.
