...
2. **Страничный и интегрирующий CSS**.
    ...
    Этот CSS описывает общий вид страницы, расположение компонентов и их дополнительную стилизацию, зависящую от места на странице и т.п.
...
CSS-препроцессоры, такие как [SASS](https://sass-lang.com/), [LESS](https://lesscss.org/), [Stylus](https://learnboost.github.com/stylus/), [Autoprefixer](https://github.com/postcss/autoprefixer) ([доступен как онлайн-инструмент](https://goonlinetools.com/autoprefixer/)) делают написание CSS значительно удобнее.

Выберите один из них и используйте. Единственное, они добавляют дополнительную предобработку CSS, которую нужно учесть, и желательно, на сервере.
