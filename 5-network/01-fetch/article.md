...
- `Proxy-*`
- `Sec-*` // МОЖНО ИЗМЕНЯТЬ
// подозреваю что не тоьлко эти можно изменять, исправьте пожалуйста потму что я пришел почитать и понять всё, а в итоге я только понял что учебник либо устарел либо что-то еще хуже, спасибо
