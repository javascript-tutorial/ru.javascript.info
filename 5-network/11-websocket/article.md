...
Коды WebSocket чем-то похожи на коды HTTP, но они разные. Коды в диапазоне `0-999` не используются. Если мы попытаемся установить такой код, то получим ошибку.
