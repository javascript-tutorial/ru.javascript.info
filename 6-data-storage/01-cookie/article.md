...
Как правило, мы указываем путь `path=/`, для чтобы наш кук был доступен со всех страниц сайта.
...
Это более "расслабленный" и не портящий впечатление от работы с сайтом подход для защиты от xsrf-атак. 
