...
Куки имеют множество особенностей и тонкостей в использовании, и в этой главе мы подробнее с ними разберёмся.

## Чтение document.cookie

```online
Содержит ли ваш сайт какие-нибудь куки? Посмотрим:
```
...
Значение свойства `document.cookie` -- это набор парных элементов `name=value`, разделённых `; `. Каждая пара представляет собой отдельное куки.
