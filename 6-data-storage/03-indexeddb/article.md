...
У нас может быть множество баз данных с различными именами, определённых в контексте текущего источника (домен/протокол/порт). Таким образом, разные сайты не могут получить доступ к базам данных друг друга.
...
Другими словами, обработка завершённых промисов и выполнение "awaits" выполняются перед завершением транзакции.
