...
Таким образом браузеры могут защитить пользователя от появления нежелательных попапов. Но все-таки функционал программного открытия новых окон не заблокирован полностью.
