...
Мы получили два разных результата из-за того, что Firefox считает таймаут в 2000мсек или менее допустимым, но все, что свыше этого – не вызывает доверия, т.к. скорее всего, происходит без ведома пользователя. Именно поэтому попап из первого примера будет заблокирован, а из второго – нет.
