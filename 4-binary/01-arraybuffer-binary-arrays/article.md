...
Работа с двоичными данными в JavaScript реализована нестандартно по сравнению с другими языками программирования. Но когда мы в этом разберёмся, то всё окажется весьма просто.
...
- Это может быть типизированный массив`TypedArray`:
    ...
    - `Uint8ClampedArray` -- для 8-битных целых, которые "зажимаются" при присвоении.
