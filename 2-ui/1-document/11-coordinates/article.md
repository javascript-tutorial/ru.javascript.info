...
Причина в том, что технически `width/height` могут принимать отрицательные значения. Прямоугольник начинается в точке `(x,y)`, а `(width,height)` -- это на самом деле вектора, по которому направлен прямоугольник.
...
Прямоугольник на картинке выше начинается из своего нижнего-правого угла и разворачивается по направлению вверх и налево.
