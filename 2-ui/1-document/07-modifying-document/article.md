...
Мы могли бы создать функцию и поместить код туда. Но альтернативным способом было бы *клонировать* существующий `div` и изменить текст внутри него (при необходимости).
