...
# HTML/CSS
Для начала создадим HTML/CSS разметку нашего меню.

Меню это отдельный графический компонент на странице, который было бы правильно вынести в отдельный DOM элемент. 
