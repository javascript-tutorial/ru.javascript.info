...
```online
В примере ниже `<div id="child">` находится внутри `<div id="parent">`. На внешнем элементе  определены обработчики событий `mouseover/out`, которые выводят информацию о них в текстовое поле.
