...
# Загрузите изображение с помощью коллбэка
...
Чтобы показать изображение сразу, мы можем создать его "продвинуто":
...
Браузер начнет загружать изображение и положит его в кэш. Позже, когда такое же изображение появится в документе (не важно как), оно будет показано мгновенно.
