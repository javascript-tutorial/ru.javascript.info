...
Или, если быть более точным, один источник (домен/порт/триплет) не может получить доступ к содержимому другого источника. Даже домен и поддомен, или просто другой порт, будут считаться разными источниками, не имеющими доступа друг к другу.
