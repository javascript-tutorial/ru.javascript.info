...
Таким образом, флаг `i` уже делает регулярные выражения более мощными, чем простой поиск по подстроке. Но возможно гораздо больше. Мы рассмотрим другие флаги и функции в следующих главах.
