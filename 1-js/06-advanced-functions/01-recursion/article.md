...
Иногда добавляют ещё одну переменную под названием `tail` для отслеживания последнего элемента списка (и обновляют ее при добавлении/удалении элементов из конца списка). Для больших наборов элементов разница скоростей по сравнению с массивами огромна.
