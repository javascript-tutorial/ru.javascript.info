...
Что довольно забавно, логика назначения `name` весьма умная. Она присваивает корректное даже имя в случае, если функция создается без имени и тут же присваивается, вот так:
