...
**Одним из важных побочных эффектов в движках JavaScript, таких как V8 (Chrome, Edge, Opera) и SpiderMonkey (Firefox), является то, что такая переменная становится недоступной при отладке.**
