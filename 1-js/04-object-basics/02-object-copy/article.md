...
Также существуют и другие методы клонирования объекта. Например, с использованием [оператора расширения](info:rest-parameters-spread) `clone = {...user}`, рассмотренного далее в учебнике.
