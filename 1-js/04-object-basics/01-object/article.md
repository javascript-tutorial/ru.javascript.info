...
Также существует другая структура данных [Map](info:map-set), которая поддерживает произвольные ключи. Мы изучим её в главе <info:map-set http://javascript.local:3000/object>.
````
