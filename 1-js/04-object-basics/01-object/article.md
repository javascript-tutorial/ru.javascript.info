...
Как мы знаем из главы <info:types>, в JavaScript существует восемь типов данных. Семь из них называются "примитивными", так как содержат только одно значение (будь то строка, число или что-то другое).
