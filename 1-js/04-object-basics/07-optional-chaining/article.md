...
Тем не менее, мы должны использовать её осторожно, только там, где по логике кода допустимо, что левая часть не существует — чтобы она не скрывала от нас ошибки программирования, если они возникнут.
