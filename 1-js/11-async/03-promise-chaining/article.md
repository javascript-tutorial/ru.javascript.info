...
Мы будем использовать метод `fetch`, чтобы подгрузить информацию о пользователях с удалённого сервера. Этот метод имеет много опциональных параметров, разобранных в соответствующем разделе, но базовый синтаксис весьма прост:
