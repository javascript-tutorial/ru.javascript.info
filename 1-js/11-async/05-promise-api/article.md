...
Быстрее всех выполниться первый промис,но с ошибкой. Поэтому мы игнорируем первый промис, который выполнен с ошибкой, и ждем следующий успешный промис, который завершаеться успешно с результатом 1. После этого остальные промисы игнорируются.
