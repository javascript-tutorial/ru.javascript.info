...
Допустим, нам нужно запустить множество промисов конкурентно и дождаться, пока все они выполнятся.

Например, за один промежуток времени загрузить несколько файлов и обработать результат, когда он готов.
