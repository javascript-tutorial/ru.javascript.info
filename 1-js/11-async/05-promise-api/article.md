...
Быстрее всех выполнился второй промис, но так как `Promise.any` ждёт первый **успешно выполненный** промис, то результат мы оплучим из третьего. Первый промис будет проигнорирован.
