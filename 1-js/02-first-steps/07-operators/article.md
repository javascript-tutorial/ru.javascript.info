...
Многие операторы знакомы нам ещё со школы – это обычные сложение `+`, умножение `*`, вычитание `-` и так далее.
...
Необходимость преобразовывать строки в числа возникает очень часто. Например, когда мы получаем значения из HTML-полей, то они обычно в форме строк.
