...
switch (age) {
  ...
  default:
    alert("Любое значение, не равное значению выше");
}
```
...
|----------------------|---------------------|
| видимо во всём блоке кода | создаётся, когда   |
...
Это был краткий список возможностей JavaScript. На данный момент мы изучили только основы. Далее в справочнике вы найдёте больше особенностей и продвинутых возможностей JavaScript. 
