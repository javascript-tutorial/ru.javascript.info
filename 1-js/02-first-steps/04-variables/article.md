...
- Делайте имена максимально описательными и локаничными. Примеры плохих имен `данные` и `значение`. Такие имена ничего не говорят. Их можно использовать только в том случае, если из контекста кода очевидно, на какие данные или значения ссылается переменная.
