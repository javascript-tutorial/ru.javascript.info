...
[Переменная](https://en.wikipedia.org/wiki/Variable_(computer_science)) -- это "именованное хранилище" для данных. Мы можем использовать их для хранения товаров, посетителей, и других данных.
...
Это может показаться короче, но мы не рекомендуем так делать. Для лучшей читаемости, пожалуйста, используйте одну строку на переменную.
