...
- В случае Объявления Функции: функция объявляется, как отдельная инструкция в основном потоке кода.
    ...
    ```
- В случае Функциональным Выражением: функция создаётся внутри выражения или другой синтаксической конструкции. В данном случае функция создаётся в правой части "выражения присваивания" `=`:
...
**Объявление Функции применимы ко всему скрипту или блоку кода.**

Другими словами, когда движок JavaScript *подготавливает* к выполнению скрипт или блок кода, прежде всего в нём происходит поиск Объявлений Функций, а затем создаются все найденные функции, созданные таким образом. Можно считать этот процесс "стадией инициализации".
...
Объявление Функции `sayHi` было создано, когда движок JavaScript приготавливал скрипт к выполнению, и такая функция отовсюду.
