...
Другими словами, когда движок JavaScript *подготавливает* к выполнению скрипт или блок кода, прежде всего в нём происходит поиск *Function Declarations*, а затем создаются все найденные функции, созданные таким образом. Можно считать этот процесс "стадией инициализации".
