...
Поэтому мы должны использовать Function Expression только тогда, когда Function Declaration не подходит для нашей задачи. Мы видели пару примеров этого в этой главе и увидим больше в будущем.
