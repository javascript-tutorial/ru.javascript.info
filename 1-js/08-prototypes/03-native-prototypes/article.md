...
Например, если мы создаём объект похожий на массив, нам может понадобиться скопировать некоторые методы массива в этот объект.
...
Заимствование методов гибкий способ, он позволяет смешивать функциональность разных объектов по необходимости.
