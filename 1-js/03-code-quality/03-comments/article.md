...
Здесь комментарии тоже не нужны: функции сами говорят, что делают. И ещё, структура кода лучше, когда он разделён на части. Понятно, что делает каждая функция, что она принимает и что возвращает.
...
Плохие комментарии только объясняют, что происходит в коде. А что делают хорошие комментарии?

Описывают архитектуру
...
Документируют использование функций
...
- Важные решения, особенно когда они неочевидны на первый взгляд.
