...
- **Горизонтальные отступы, при вложенности – два (или четыре) пробела.**
    ...
    Горизонтальный отступ выполняется с помощью 2 или 4 пробелов, или символа "Tab". Какой из них выбрать - это уже на ваше усмотрение. Пробелы более распространены в наши дни.
