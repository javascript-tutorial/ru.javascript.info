...
*Контрольные точки* – это участок кода, где отладчик автоматически приостановит исполнение JavaScript.
...
- Быстро переместиться к любой контрольной точке в коде – нужно щёлкнуть по точке в правой части экрана.
...
```smart header="Условные контрольные точки"
Можно задать и так называемую *условную* контрольную точку – щёлкните правой кнопкой мыши по номеру строки в коде. Если задать выражение, то именно при его истинности выполнение кода будет приостановлено.
