...
Первый тип это *свойства-данные (data properties)*. Мы уже знаем, как работать с ними. На самом деле, все свойства, которые мы использовали до текущего момента были свойствами-данных.
...
Как только свойство определено с помощью `get prop()` или `set prop()`, оно становится свойством-аксессора, а не свойством-данных.
...
Дескрипторы свойств-аксессора отличаются в сравнении со свойствами-данных.
