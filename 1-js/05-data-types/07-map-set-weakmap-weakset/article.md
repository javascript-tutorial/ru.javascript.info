...
- `WeakSet` -- вариант `Set`, который хранит только объекты и удаляет их, если они становятся недостижимыми другими путями.
