...
Примем за условие, что каждое сообщение конкретного пользователя является уникальным, т.е. текст каждого сообщения будет отличаться от любого другого сообщения этого пользователя.
