...
: Создать объект `Date` с заданными компонентами в местном часовом поясе. Обязательны только первые два аргумента.
    ...
    - `year` с 1900 по 1999 можно задать как полностью, так и сокращенно. То есть числа от 0 до 99 будут автоматически увеличены на 1900, числа от 100 до 275760 будут приняты как есть, число же выше 275760 будет недопустимой датой. Для того, чтобы задать год именно от 0 до 99 нужно воспользоваться методом `setFullYear`.
