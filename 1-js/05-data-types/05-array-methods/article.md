...
Он начинает с позиции `pos`, удаляет `deleteCount` элементов и вставляет `elem1, ..., elemN` на их место. Возвращает массив из удалённых элементов.
...
- Для добавления/удаления элементов:  
  ...
  - `splice(pos, deleteCount, ...items)` -- начиная с позиции `pos`, удаляет `deleteCount` элементов и вставляет `items`.
