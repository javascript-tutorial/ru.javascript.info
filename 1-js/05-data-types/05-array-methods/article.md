...
Вызов [arr.join(separator)](mdn:js/Array/join) делает в точности противоположное `split`. Он создаёт строку из елементов `arr` _склеивая_ их и вставляя `separator` между ними.
