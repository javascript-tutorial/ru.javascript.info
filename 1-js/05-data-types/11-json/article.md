...
Полученная строка `json` называется *JSON-форматированным*, *сериализованным*, *содержащим строковые данные* или же *упорядоченным* объектом. Мы можем отправить его по сети или поместить в обычное хранилище данных.
