...
```js run
let str1 = "Hello\nWorld"; // две строки при помощи "символа перевода строки"

// две строки при помощи нормального перевода строки и обратных кавычек
let str2 = `Hello
World`;
...
Есть и другие, реже используемые "специальные" символы.
