 ...
 **base=36** — максимальное основание, цифры могут быть `0..9` или `A..Z`. Используется весь латинский алфавит для представления числа. Забавно, но можно использовать `36`-разрядную систему счисления, когда мы хотим сократить слишком большой числовой идентификатор, например, можно создать короткую ссылку. Можно просто преобразовать в `36`-систему счисления:
...
Число хранится в памяти в бинарной форме, последовательность единиц и нулей. Но дроби как `0.1`, `0.2`, которые выглядят довольно просто в десятичной системе счисления, на самом деле являются бесконечной дробью в двоичной форме.
...
// вернет true, если аргумент является не числом, Infinity или -Infinity
alert( isFinite(num) );
```
