...
С другой стороны, использование тех же функций `String/Number/Boolean` без оператора `new` - это совершенно то же самое и практичнее. Они превращают значение в соответствующий примитивный тип: в строку, в число, в булевый тип.
