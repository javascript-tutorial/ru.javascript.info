...
Элементы массива индексируются, начиная с нуля.
...
Просто взять и удалить элемент с индексом `0` недостаточно. Нужно также заново переиндексировать остальные элементы.

Операция `shift` должна выполнить 3 действия:

1. Удалить элемент с индексом `0`.
2. Сдвинуть все элементы влево и обновить их индексы, заменив `1` на `0`, `2` на `1` и т.д.
...
Чтобы избежать появления таких неожиданных ситуаций, мы обычно используем квадратные скобки, если, конечно, не знаем точно, что по какой-то причине нужен именно `new Array`.
