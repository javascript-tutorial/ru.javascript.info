...
Массив – это объект особого вида. Квадратные скобки, используемые для того, чтобы получить доступ к свойству `arr[0]`, фактически обусловлены синтаксисом объекта. В качестве ключей используются числа.
