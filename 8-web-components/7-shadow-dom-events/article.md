...
**События, которые произошли в теневом DOM, но вне компонента, имеют в качестве целевого элемента -- элемент-"хозяин" (host element).**
...
Хорошо, что у нас есть перенаправление событий. Потому что внешний документ ничего не знает о внутреннем устройстве компонента. С такой точки зрения, событие происходит на `<user-card>`.
