...
Первый: можно стилизовать сам `<slot>` и полагаться на наследование CSS:
...
Другой вариант: использовать псевдоэлемент `::slotted(селектор)`. Соответствует элементам, если выполняются два условия:
